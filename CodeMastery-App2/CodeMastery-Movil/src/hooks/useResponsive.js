...
const useResponsive = () => {
  // Valores por defecto seguros para evitar undefined
  ...
  useEffect(() => {
    ...
    // Listener para cambios de dimensiones
  ...
  // Safe area styles simplificados
  ...
  const getResponsiveValue = (small, medium, large) => {
    if (screenData.width < 375) return small;
    if (screenData.width >= 768) return large;
    return medium;
  };
  ...
  return {
    ...
    isLargeScreen: screenData.width >= 768,
