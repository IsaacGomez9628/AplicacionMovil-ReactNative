  ...
  return (
    <AuthContainer statusBarStyle="light-content">
      <ScreenTransition type="slideUp">
        <StatusIndicator type="error" message={message} visible={showError} onHide={() => setShowError(false)} />

        <StatusIndicator type="success" message={message} visible={showSuccess} onHide={() => setShowSuccess(false)} />
        ...
        <View style={styles.content}>
          ...
          <ScreenTransition type="fadeIn" delay={1000}>
            ...
            <AuthButton variant="text" onPress={() => navigation.navigate("Login")} icon="arrow-left">
